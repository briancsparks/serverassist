  ...
  return MongoClient.connect(mongoHost, (err, db) => {
    ...
    // ---------- Build Config ----------
      ...
      return sg.__run([function(next) {
        ...
        //setOnn(result, 'app_prj.sap_dbgtelemetry',  sg.extract(result.app_prj, 'sap_dbgtelemetry'));
        //setOnn(result, 'app_prj.mwp_dbgtelemetry',  sg.extract(result.app_prj, 'mwp_dbgtelemetry'));
        setOnn(result, 'app_prj.sa_dbgtelemetry',   sg.extract(result.app_prj, 'sa_dbgtelemetry'));
